...
- [x] Evidence Assessment & 3rd-Party Workflow:
  ...
  - [x] **Sequential Workflow**: Enforce Manager assessment before ITA assignment/assessment logic in `AssessmentService`. Once an ITA assessment is finalized, the status transitions to `INDEPENDENTLY_ASSESSED`.
